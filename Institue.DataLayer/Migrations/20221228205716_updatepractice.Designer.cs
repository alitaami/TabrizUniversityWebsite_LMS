...
namespace Institue.DataLayer.Migrations
{
    ...
    [Migration("20221228205716_updatepractice")]
    partial class updatepractice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Institue.DataLayer.Entities.Lesson.LessonPractice", b =>
                {
                    b.Property<int>("LessonPracticeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("LessonPracticeDescription")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("LessonPracticeId");

                    b.HasIndex("LessonDetailId");

                    b.ToTable("LessonPractice");
                });

            modelBuilder.Entity("Institue.DataLayer.Entities.Lesson.LessonProject", b =>
                {
                    b.Property<int>("LessonProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("LessonProjectDescription")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("LessonProjectId");

                    b.HasIndex("LessonDetailId");

                    b.ToTable("LessonProject");
                });
            ...
            modelBuilder.Entity("Institue.DataLayer.Entities.Lesson.LessonPractice", b =>
                {
                    b.HasOne("Institue.DataLayer.Entities.Lesson.LessonDetail", "LessonDetail")
                        .WithMany("LessonPractice")
